...
class Lista:
  ...
  def __str__(self):
    if self.inicio:
      ...
      retorno += "\033[96m{: ^34} \033[00m|\033[96m {: ^30s}\033[00m | \033[96m{: ^32s}\033[00m |\033[96m{: ^34s} |\033[00m\n".format('endereço do nó', 'dado','proximo', 'anterior')
  ...
  def printReverso(self) :
    retorno = ''

    if self.final:
      no_auxiliar = self.final

      while( no_auxiliar.anterior ):
        retorno += "\033[96m{:<30}\033[00m\n".format(no_auxiliar.dado)
  ...
  def adicionar(self, valor):
    ...
    if self.inicio:
      ...
      self.final = no_auxiliar.proximo
